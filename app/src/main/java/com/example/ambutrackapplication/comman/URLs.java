...
public class URLs {
    public static String WebServiceAddress="http://192.168.113.27:80/AmbuTrackerAPI/";
    public static String userLoginWebSerivce=WebServiceAddress+"UserLoginDetails.php";
    public static String userregisterWebService=WebServiceAddress+"UserRegistrationDetails.php";
    ...
    public static String userUpdateProfileWebService=WebServiceAddress+"useruUpdateProfile.php";
}
