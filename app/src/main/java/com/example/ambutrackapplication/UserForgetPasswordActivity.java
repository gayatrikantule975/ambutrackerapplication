    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(UserForgetPasswordActivity.this, "Please Enter Valid OTP", Toast.LENGTH_SHORT).show();
                }
                ...
                if (strVerificationCode!=null){
                    progressDialog= new ProgressDialog(UserForgetPasswordActivity.this);
                    ...
                    FirebaseAuth.getInstance().signInWithCredential(phoneAuthCredential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                ...
                                progressDialog.dismiss();
                                Toast.makeText(UserForgetPasswordActivity.this, "Invalid OTP !! Enter Valid OTP", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
                else {
                    Toast.makeText(UserForgetPasswordActivity.this, "OTP not received", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        tvResendOTP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PhoneAuthProvider.getInstance().verifyPhoneNumber("+91" + strMobileNo, 60, TimeUnit.SECONDS,
                        UserForgetPasswordActivity.this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            @Override
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                ...
                                progressDialog.dismiss();
                                Toast.makeText(UserForgetPasswordActivity.this,"Verification Failed",Toast.LENGTH_SHORT).show();
